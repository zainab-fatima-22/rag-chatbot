    ...
    <div className="min-h-full grid lg:grid-cols-2 bg-paper-dim">
      <div className="hidden lg:flex flex-col justify-center bg-ink text-paper px-16">
        ...
        <h2 className="font-display text-3xl mb-4 leading-snug">
          Welcome back to your tax record.
        </h2>
        <p className="text-paper/70 text-sm leading-relaxed mb-8 max-w-sm">
          Log in to continue your conversation, revisit past answers, and pick
          up your filing questions exactly where you left them.
        </p>
        <ul className="space-y-3 text-sm text-paper/80">
          <li className="flex gap-2"><span className="text-brass-light">＋</span> Saved conversation history</li>
          <li className="flex gap-2"><span className="text-brass-light">＋</span> Answers grounded in FBR guidance</li>
          <li className="flex gap-2"><span className="text-brass-light">＋</span> Built for salaried and freelance filers</li>
        </ul>
      </div>
