...
Updated the README to document the project's automated testing setup, recent bug fixes, and quality improvements. This includes Jest test coverage, email normalization, and prevention of duplicate form submissions.
